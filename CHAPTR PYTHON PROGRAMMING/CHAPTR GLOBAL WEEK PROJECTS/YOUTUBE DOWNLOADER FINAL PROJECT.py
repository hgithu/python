...
class Utube_down:
    def __init__(self, root):
        ...
        title = Label(self.root, text='Youtube Downloader', font=("algerian", 15), bg="#262626", fg='white').pack(
            side=TOP, fill=X)

        self.var_url = StringVar()

        lbl_url = Label(self.root, text='Video URL', font=("times new roman", 15), bg='white').place(x=10, y=50)
        txt_url = Entry(self.root, textvariable=self.var_url, font=("times new roman", 13),bg="#d9fcff").place(x=120,
                                                                                                            y=50,
                                                                                                            width=340,
                                                                                                            height=30)
        ...
        video_radio = Radiobutton(self.root, text='Video', variable=self.var_fileType, value='Video',
                                  font=("times new roman", 13), bg='white', activebackground='white').place(x=120, y=90)
        audio_radio = Radiobutton(self.root, text='Audio', variable=self.var_fileType, value='Audio',
                                  font=("times new roman", 13), bg='white', activebackground='white').place(x=220, y=90)
        btn_search = Button(self.root, text='Search', font=('times new roman', 15), bg='lightblue',
                            command=self.search).place(x=350, y=90, width=120, height=35)
        ...
        self.video_img = Label(frame_, text='Video \nImage ', font=("times new roman", 15), bg="lightgrey", bd=2,
                               relief=RIDGE)
        ...
        btn_clear = Button(self.root, text='Clear', command=self.clear, font=('times new roman', 13), bg='red',
                           fg='white').place(x=330, y=330, width=60, height=25)
        self.btn_download = Button(self.root, text='Download', state=DISABLED, command=self.dwnld,
                                   font=('times new roman', 13), bg='green', fg='white')
